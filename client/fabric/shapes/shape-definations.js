export const shapeDefinitions = {
  rectangle: {
    type: "rect",
    label: "Rectangle",
    defaultProps: { width: 100, height: 60, fill: "#000000" },
  ...
  square: {
    type: "rect",
    label: "Square",
    defaultProps: { width: 80, height: 80, fill: "#000000" },
    thumbnail: (fabric, canvas) => {
      const { Rect } = fabric;
  ...
  circle: {
    type: "circle",
    label: "Circle",
    defaultProps: { radius: 50, fill: "#000000" },
    thumbnail: (fabric, canvas) => {
      const { Circle } = fabric;
  ...
  ellipse: {
    type: "ellipse",
    label: "Ellipse",
    defaultProps: { rx: 60, ry: 30, fill: "#000000" },
    thumbnail: (fabric, canvas) => {
  ...
  star: {
    type: "polygon",
    label: "Star",
    defaultProps: { fill: "#000000", points: [] },
    thumbnail: (fabric, canvas) => {
...
export const shapeDefinations = shapeDefinitions;
