    ...
    return (
        <div className="h-full overflow-y-auto">
            <div className="p-4 space-y-4">
                <Button onClick={handleAddCustomTextBox} className="w-full py-3 px-4 bg-purple-600 hover:bg-purple-700 text-white rounded-md flex items-center justify-center transition-colors">
                    ...
                    <div className="space-y-2">
                        {
                            textPresets.map((preset,index)=>(
                                <button
                                    ...
                                    style={{fontSize: `${Math.min(preset.fontSize/1.8,24)}px`,
                                            fontWeight: preset.fontWeight,
                                            fonstStyle: preset.fontStyle || 'normal',
